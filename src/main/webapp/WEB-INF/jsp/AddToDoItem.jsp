        ...
        <form:form action="/saveToDoItem" method="post" modelAttribute="todo">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		...
            		<div class="col-md-6">
            		    <input type="text" path="title" id="title"
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		...
            		<div class="col-md-6">
            			<input type="date" path="date" id="date"
            				class="form-control input-sm" required="required" />
            		</div>
            	</div>
            </div>
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		...
            		<div class="col-md-6">
            			<input type="text" path="status" id="status"
            ...
            <div class="row p-2">
            	<div class="col-md-2">
            		<button type="button" class="btn btn-success" #msgBox>Save</button>
            	</div>
